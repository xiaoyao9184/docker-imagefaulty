...
I found that DALAI-project/FaultyImageAPI's Docker image is difficult to find.
The code on [GitHub](https://github.com/DALAI-project/FaultyImageAPI) does not provide a pre-built Docker image.
...
The images of this project will be published to Docker Hub under the repository [xiaoyao9184/image-faulty](https://hub.docker.com/r/xiaoyao9184/image-faulty).

Since this project references the FaultyImageAPI project via a submodule, it cannot monitor push events on the FaultyImageAPI project, and therefore cannot automatically create an image for every commit.
...
The default image name format is `${DOCKERHUB_USERNAME}/image-faulty`.
